...
--rename
vim.api.nvim_set_keymap("n", "gn", "<cmd>lua require('lspsaga.rename').rename()<CR>", opts)
vim.api.nvim_set_keymap("n", "K", "<cmd>lua require('lspsaga.hover').render_hover_doc()<CR>", opts)
vim.api.nvim_set_keymap("n", ",k", "<cmd>lua require('lspsaga.action').smart_scroll_with_saga(1)<CR>", opts)
vim.api.nvim_set_keymap("n", ",j", "<cmd>lua require('lspsaga.action').smart_scroll_with_saga(-1)<CR>", opts)
